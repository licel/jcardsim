...
public interface DESKey
    ...
    /**
     * Sets the <code>Key</code> data. The plain text length of input key data is 8 bytes for DES,
     ...
     * </ul>
     * @throws NullPointerException - if the <CODE>keyData</CODE> parameter is <CODE>null</CODE>
     ...
     * time the initialized state of the key was set to false.</li>
     * </ul>
     * @see Key
     */
