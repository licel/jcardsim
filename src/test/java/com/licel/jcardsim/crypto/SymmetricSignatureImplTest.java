...
public class SymmetricSignatureImplTest extends TestCase {
    ...
    // {KEY, TEXT, MAC}, ..
    String[][] HMAC_TESTS = {
        // RFC - 2202 MD5 test case 1
        {"0B0B0B0B0B0B0B0B0B0B0B0B0B0B0B0B",
         "4869205468657265",
         "9294727A3638BB1C13F48EF8158BFC9D"},
        // RFC - 2202 MD5 test case 2
        {"4A656665",
         "7768617420646F2079612077616E7420666F72206E6F7468696E673F",
         "750C783E6AB0B503EAA86E310A5DB738"},
        // RFC - 2202 MD5 test case 3
        {"AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA",
         "DDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDD",
         "56BE34521D144C88DBB8C733F0E8B3F6"},
        // RFC - 2202 MD5 test case 4
        {"0102030405060708090A0B0C0D0E0F10111213141516171819",
         "CDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCD",
         "697EAF0ACA3A3AEA3A75164746FFAA79"},
        // RFC - 2202 MD5 test case 5
        {"0C0C0C0C0C0C0C0C0C0C0C0C0C0C0C0C",
         "546573742057697468205472756E636174696F6E",
         "56461EF2342EDC00F9BAB995690EFD4C"},
        // RFC - 2202 MD5 test case 6
        {"AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA",
         "54657374205573696E67204C6172676572205468616E20426C6F636B2D53697A65204B6579202D2048617368204B6579204669727374",
         "6B1AB7FE4BD7BF8F0B62E6CE61B9D0CD"},
        // RFC - 2202 MD5 test case 7
        {"AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA",
         "54657374205573696E67204C6172676572205468616E20426C6F636B2D53697A65204B657920616E64204C6172676572205468616E204F6E6520426C6F636B2D53697A652044617461",
         "6F630FAD67CDA0EE1FB1F562DB3AA53E"},
        // RFC - 2202 SHA1 test case 1
        {"0B0B0B0B0B0B0B0B0B0B0B0B0B0B0B0B0B0B0B0B",
         "4869205468657265",
         "B617318655057264E28BC0B6FB378C8EF146BE00"},
        // RFC - 2202 SHA1 test case 2
        {"4A656665",
         "7768617420646F2079612077616E7420666F72206E6F7468696E673F",
         "EFFCDF6AE5EB2FA2D27416D5F184DF9C259A7C79"},
        // RFC - 2202 SHA1 test case 3
        {"AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA",
         "DDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDD",
         "125D7342B9AC11CD91A39AF48AA17B4F63F175D3"},
        // RFC - 2202 SHA1 test case 4
        {"0102030405060708090A0B0C0D0E0F10111213141516171819",
         "CDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCDCD",
         "4C9007F4026250C6BC8414F9BF50C86C2D7235DA"},
        // RFC - 2202 SHA1 test case 5
        {"0C0C0C0C0C0C0C0C0C0C0C0C0C0C0C0C0C0C0C0C",
         "546573742057697468205472756E636174696F6E",
         "4C1A03424B55E07FE7F27BE1D58BB9324A9A5A04"},
        // RFC - 2202 SHA1 test case 6
        {"AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA",
         "54657374205573696E67204C6172676572205468616E20426C6F636B2D53697A65204B6579202D2048617368204B6579204669727374",
         "AA4AE5E15272D00E95705637CE8A3B55ED402112"},
        // RFC - 2202 SHA1 test case 7
        {"AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA",
         "54657374205573696E67204C6172676572205468616E20426C6F636B2D53697A65204B657920616E64204C6172676572205468616E204F6E6520426C6F636B2D53697A652044617461",
        ...
        // RFC - 4231 SHA-256 test case 3
        {"AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA",
         "DDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDD",
         "773EA91E36800E46854DB8EBD09181A72959098B3EF8C122D9635514CED565FE"},
        // RFC - 4231 SHA-384 test case 3
        {"AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA",
         "DDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDD",
