...
/**
 * Test javacard sample (demo2crypto).
 */
public class demo2cryptoTest extends TestCase {
    ...
    /**
     * Test of javacard sample (demo2crypto).
     */
    public void testExecuteCommands() throws Exception {
        ...
        cfg.setProperty("com.licel.jcardsim.smartcardio.applet.0.AID", "a00000006203010c0b01");
        cfg.setProperty("com.licel.jcardsim.smartcardio.applet.0.Class", "com.sun.javacard.samples.JavaPurseCrypto.JavaPurseCrypto");
        ...
        sb.append("powerup;\n");
        sb.append("// create JavaPurseCrypto\n");
        sb.append("0x80 0xB8 0 0 0x0c 0x0a 0xa0 0 0 0 0x62 0x03 0x01 0x0c 0xb 0x01 0 0x7F;\n");
        ...
        sb.append("0x00 0xa4 0x04 0x00 10 0xa0 0 0 0 0x62 3 1 0xc 0xb 1 127;\n");
        ...
        sb.append("0x80 0x26 0x00 0x00 0x1A 0x11 0x22 0x33 0x44 0x00 0x00 0x00 0x00 0xC1 0x08 0x01 0x02 0x03 0x04 0x05 0x06 0x07 0x08 0x19 0x82 0xd1 0x8e 0x8d 0xe8 0x18 0xdc 0x7F;\n");
        ...
        sb.append("0x80 0x26 0x00 0x00 0x16 0x11 0x22 0x33 0x44 0x00 0x00 0x00 0x00 0xC2 0x04 0x01 0x02 0x03 0x04 0x86 0x39 0x91 0x2c 0x5a 0x10 0x59 0x47 0x7F;\n");
        sb.append("// 00 00 00 00 00 00 00 00 90 00;\n");
        sb.append("// Initialize Parameter Update\n");
        sb.append("0x80 0x24 0x00 0x00 0x00 0x7F;\n");
        ...
        sb.append("0x80 0x26 0x00 0x00 0x15 0x11 0x22 0x33 0x44 0x00 0x00 0x00 0x00 0xC5 0x03 0x0c 0x1f 0x62 0x95 0xc9 0x3b 0x6f 0x1f 0xdd 0xa1 0x1a 0x7F;\n");
        sb.append("// 00 00 00 00 00 00 00 00 90 00;\n");
        sb.append("// Initialize Parameter Update\n");
        sb.append("0x80 0x24 0x00 0x00 0x00 0x7F;\n");
        ...
        sb.append("0x80 0x26 0x00 0x00 0x16 0x11 0x22 0x33 0x44 0x00 0x00 0x00 0x00 0xC6 0x04 0x05 0x05 0x05 0x05 0x7c 0x17 0xb3 0x12 0x45 0x4a 0x64 0xf7 0x7F;\n");
        sb.append("// 00 00 00 00 00 00 00 00 90 00;\n");
        sb.append("// Initialize Parameter Update\n");
        sb.append("0x80 0x24 0x00 0x00 0x00 0x7F;\n");
        ...
        sb.append("0x80 0x26 0x00 0x00 0x14 0x11 0x22 0x33 0x44 0x00 0x00 0x00 0x00 0xC7 0x02 0x7D 0x00 0xd7 0xde 0x72 0x80 0x4f 0xa5 0x95 0xb8 0x7F;\n");
        sb.append("// 00 00 00 00 00 00 00 00 90 00;\n");
        sb.append("// Initialize Parameter Update\n");
        sb.append("0x80 0x24 0x00 0x00 0x00 0x7F;\n");
        ...
        sb.append("0x80 0x26 0x00 0x00 0x14 0x11 0x22 0x33 0x44 0x00 0x00 0x00 0x00 0xC8 0x02 0x0B 0xB8 0xa0 0x93 0x8d 0xa0 0x4c 0xb0 0xb4 0x47 0x7F;\n");
        sb.append("// 00 00 00 00 00 00 00 00 90 00;\n");
        sb.append("// Initialize Parameter Update\n");
        sb.append("0x80 0x24 0x00 0x00 0x00 0x7F;\n");
        ...
        sb.append("0x80 0x26 0x00 0x00 0x16 0x11 0x22 0x33 0x44 0x00 0x00 0x00 0x00 0xC9 0x04 0x02 0x01 0x00 0x01 0xe8 0xe5 0xac 0x09 0xec 0xea 0x5f 0xfe 0x7F;\n");
        sb.append("// 00 00 00 00 00 00 00 00 90 00;\n");
        sb.append("// Initialize Parameter Update\n");
        sb.append("0x80 0x24 0x00 0x00 0x00 0x7F;\n");
        ...
        sb.append("0x80 0x26 0x00 0x00 0x1E 0x11 0x22 0x33 0x44 0x00 0x00 0x00 0x00 0xCA 0x0C 0x33 0x55 0xA0 0x00 0x00 0x00 0x62 0x03 0x01 0x0C 0x05 0x01 0xb1 0x5d 0x5a 0x4b 0xc1 0x3f 0x62 0x0b 0x7F;\n");
        sb.append("// 00 00 00 00 00 00 00 00 90 00;\n");
        sb.append("//////////////////////////////////////////////////////////////////////\n");
        ...
        sb.append("0x80 0x22 0x00 0x00 0x0d 0xf5 0x4f 0x26 0xeb 0x31 0x8e 0x0e 0x7c 0x0a 0x1b 0x61 0x0f 0x21 0x7F;\n");
        ...
        sb.append("0x80 0x22 0x00 0x00 0x0d 0x3b 0x5d 0x5a 0x80 0xba 0x47 0x08 0xd5 0x0a 0x1b 0x61 0x0f 0x23 0x7F;\n");
        ...
        sb.append("0x80 0x22 0x00 0x00 0x0d 0x5d 0x41 0xe2 0xac 0xa2 0x3d 0xff 0x15 0x0a 0x1b 0x61 0x11 0x2d 0x7F;\n");
        ...
        sb.append("0x80 0x22 0x00 0x00 0x0d 0x85 0x1f 0x35 0x96 0x53 0xda 0x25 0xa2 0x0a 0x1c 0x61 0x12 0x2d 0x7F;\n");
        ...
        sb.append("0x80 0x22 0x00 0x00 0x0d 0x65 0x79 0x7a 0x49 0x24 0x35 0xf5 0x14 0x0a 0x1c 0x61 0x12 0x35 0x7F;\n");
        ...
        sb.append("0x80 0x26 0x00 0x00 0x14 0x11 0x22 0x33 0x44 0x00 0x00 0x00 0x00 0xC8 0x02 0x4E 0x20 0x95 0xc9 0x3b 0x6f 0x1f 0xdd 0xa1 0x1a 0x7F;\n");
        sb.append("// 00 00 00 00 00 00 00 00 90 00;\n");
        sb.append("// Select JavaPurse\n");
        sb.append("0x00 0xa4 0x04 0x00 10 0xa0 0 0 0 0x62 3 1 0xc 0xb 1 127;\n");
        sb.append("// 90 00 = SW_NO_ERROR\n");
