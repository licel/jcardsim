...
/**
 * Test javacard sample (odDemo1-1).
 */
public class odDemo11Test extends TestCase {
    ...
    /**
     * Test of javacard sample (odDemo1-1).
     */
    public void testExecuteCommands() throws Exception {
        ...
        sb.append("powerup;\n");
        sb.append("//Scenario 1 - Object Deletion\n");
        ...
        sb.append("// 90 00 SW_NO_ERROR\n");
        sb.append("//setup transient\n");
        sb.append("0xC0 0x20 0x00 0x00 0x00 0x7F;\n");
        sb.append("// 90 00 SW_NO_ERROR\n");
        sb.append("//setup persistent\n");
        sb.append("0xC0 0x19 0x00 0x00 0x00 0x7F;\n");
        sb.append("// 90 00 SW_NO_ERROR\n");
        sb.append("//call removetrees\n");
        sb.append("0xC0 0x11 0x00 0x00 0x00 0x7F;\n");
        sb.append("// 90 00 SW_NO_ERROR\n");
        sb.append("//request Object Deletion\n");
        sb.append("0xC0 0x10 0x00 0x00 0x00 0x7F;\n");
        sb.append("// 90 00 SW_NO_ERROR\n");
        sb.append("//analyze remove trees\n");
        sb.append("0xC0 0x12 0x00 0x00 0x00 0x7F;\n");
        sb.append("// 90 00 SW_NO_ERROR\n");
        sb.append("//deselect Applet A's instance by selecting it again\n");
        sb.append("0x00 0xA4 0x04 0x00 0x0B 0xA0 0x00 0x00 0x00 0x62 0x03 0x01 0x0C 0x07 0x01 0x01 0x7F;\n");
        sb.append("// 90 00 SW_NO_ERROR\n");
        sb.append("//request Object Deletion\n");
        sb.append("0xC0 0x10 0x00 0x00 0x00 0x7F;\n");
        sb.append("// 90 00 SW_NO_ERROR\n");
        sb.append("//analyze transient deselect memory gone\n");
        sb.append("0xC0 0x13 0x00 0x00 0x00 0x7F;\n");
        sb.append("// 90 00 SW_NO_ERROR\n");
        sb.append("//reset the card\n");
        sb.append("powerdown;\n");
